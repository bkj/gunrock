...
cudaError_t Advance(
    ...
    OpT             op)
{
    return oprtr::advance::Launch<FLAG>(
...
{
    return oprtr::advance::Launch<FLAG>(
        graph, frontier_in, frontier_out, parameters, advance_op, filter_op);
}
...
//            graph, frontier_in, frontier_out, parameters, op);
    ...
    //        graph, frontier_in, frontier_out, parameters, op);
    return util::GRError(cudaErrorInvalidValue,
        "OprtrType " + parameters.oprtr_type + " undefined.", __FILE__, __LINE__);
}
